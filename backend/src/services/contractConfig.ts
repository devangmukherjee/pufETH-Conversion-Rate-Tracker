export const abi = [
  ...
  { inputs: [], name: "DepositAndWithdrawalForbidden", type: "error" },
  ...
  { inputs: [], name: "InvalidExitFeeBasisPoints", type: "error" },
  ...
  { inputs: [], name: "WithdrawalsAreDisabled", type: "error" },
  {
    anonymous: false,
    inputs: [
      {
  ...
  },
  {
    ...
    inputs: [
      {
        indexed: false,
        internalType: "uint256",
        name: "previousTotalRewardsAmount",
        type: "uint256",
      },
      {
        indexed: false,
        internalType: "uint256",
        name: "newTotalRewardsAmount",
        type: "uint256",
      },
      {
        indexed: false,
    ...
    name: "UpdatedTotalRewardsAmount",
    type: "event",
  },
  {
    anonymous: false,
  ...
  },
  {
    ...
    name: "PUFFER_ORACLE",
    outputs: [
      { internalType: "contract IPufferOracle", name: "", type: "address" },
    ],
    stateMutability: "view",
    type: "function",
  },
  ...
  {
    inputs: [{ internalType: "uint96", name: "newLimit", type: "uint96" }],
